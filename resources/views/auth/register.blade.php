...
<header class="fixed inset-x-0 top-0 z-50 bg-white">
  ...
  <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
    <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">REGISTER HERE</h2>
    ...
    <div class="mb-4">
        <label for="no_hp" class="block text-sm font-medium text-gray-700">Number Phone</label>
    ...
    <div class="mb-4">
      ...
      <!-- <button class="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
        Sign in
      </button> -->
            <div class="flex justify-center mt-4">
            <!-- <a href="/login" class="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-center">
            {{ __('sign in') }}
            </a> -->
